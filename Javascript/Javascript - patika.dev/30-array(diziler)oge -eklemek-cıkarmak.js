...
items[items.length - 1] = 10      // length normal sayar 1,2,3,4,5 diye -1 yazınca en son eleman olur
console.log(items)

items[2] = 2000
console.log(items)

let names = ['Ahmet', 'Yusuf', 'Can', 'Mehmet']

names.unshift('ilk eleman');
...
tech.sort()                 // a dan z ye dizer.
console.log(tech);
tech.reverse()              // z den a ya dizer.
console.log(tech)
